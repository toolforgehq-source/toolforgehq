...
export default function Templates() {
  ...
  const updateSearchParams = (category: string | null, subcategory: string | null, sort: SortOption) => {
  ...
  const handleCategoryChange = (categoryId: string | null) => {
    ...
    updateSearchParams(categoryId, null, sortBy);
  };

  const handleSubcategoryChange = (subcategoryId: string | null) => {
    setSelectedSubcategory(subcategoryId);
    updateSearchParams(selectedCategory, subcategoryId, sortBy);
  };

  const handleSortChange = (sort: SortOption) => {
    setSortBy(sort);
    updateSearchParams(selectedCategory, selectedSubcategory, sort);
  };
